...
## Goal
Implement a production-ready authentication system using Google OAuth2. This serves as the foundation for user identity in the application.

## User Stories
- As a user, I want to click a "Sign in with Google" button so I don't have to remember a new password.
- As a user, I want to see my Google profile name and email once logged in so I know I am in the right account.
- As a user, I want to be able to sign out securely.
- As a developer, I want my session persisted in a database so I don't lose my login state on refresh.
...
3. Navigate to **APIs & Services > OAuth consent screen** and configure it for "External".
...
## Backlog Preview
- [ ] Initialize Next.js and Prisma [passes: false]
